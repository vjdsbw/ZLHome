...
const _sfc_main = {
  ...
  created() {
    if (!(common_vendor.St.config && common_vendor.St.config.provider)) {
      this.noSpace = true;
      common_vendor.St.chooseAndUploadFile = uni_modules_uniFilePicker_components_uniFilePicker_chooseAndUploadFile.chooseAndUploadFile;
    }
  ...
  methods: {
    ...
    chooseFiles() {
      ...
      common_vendor.St.chooseAndUploadFile({
    ...
    async getTempFileURL(fileList) {
      ...
      const urls = await common_vendor.St.getTempFileURL(fileList);
...
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "C:/Study/geek/15.uni-app/ZLHome/uni_modules/uni-file-picker/components/uni-file-picker/uni-file-picker.vue"]]);
